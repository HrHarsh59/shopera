...
import project.demo.shopera.menubar.AccountFragmentDirections
import project.demo.shopera.model.ProductData

class LikeProductAdapter(
    options: FirestoreRecyclerOptions<ProductData>
) : FirestoreRecyclerAdapter<ProductData, LikeProductAdapter.ProductDataViewHolder>(options) {
    ...
    override fun onBindViewHolder(
        ...
        holder.productImageView.setOnClickListener {
            val navigation = AccountFragmentDirections.actionAccountFragmentToProductFragment(
