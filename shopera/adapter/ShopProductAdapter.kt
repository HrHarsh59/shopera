...
import project.demo.shopera.ShopProfileFragmentDirections
import project.demo.shopera.model.ProductData

class ShopProductAdapter(
    options: FirestoreRecyclerOptions<ProductData>
) : FirestoreRecyclerAdapter<ProductData, ShopProductAdapter.ProductDataViewHolder>(options) {
    ...
    override fun onBindViewHolder(
        ...
        holder.productImageView.setOnClickListener {
            val navigation = ShopProfileFragmentDirections.actionShopProfileFragmentToProductFragment(
