...
class ProductSearchAdapter(
...
) : FirestoreRecyclerAdapter<ProductData, ProductSearchAdapter.ProductDataViewHolder>(options) {
    ...
    override fun onBindViewHolder(
        ...
        holder.productImageView.setOnClickListener {
            val navigation = SearchFragmentDirections.actionSearchFragmentToProductFragment2(
