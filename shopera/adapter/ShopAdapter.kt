...
import project.demo.shopera.MainFragmentDirections
import project.demo.shopera.R
import project.demo.shopera.model.ShopData

class ShopAdapter(options: FirestoreRecyclerOptions<ShopData>)
    : FirestoreRecyclerAdapter<ShopData, ShopAdapter.ShopDataViewHolder>(options) {
    ...
    override fun onBindViewHolder(
        ...
        holder.shopCard.setOnClickListener {
            val navigation = MainFragmentDirections.actionMainFragmentToShopProfileFragment(
