...
class ProductAdapter(
...
) : FirestoreRecyclerAdapter<ProductData, ProductAdapter.ProductDataViewHolder>(options) {
    ...
    override fun onBindViewHolder(
        ...
        holder.productImageView.setOnClickListener {
            val navigation = MainFragmentDirections.actionMainFragmentToProductFragment(
